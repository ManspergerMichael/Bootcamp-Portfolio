...
namespace MusicLINQ
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //=========================================================
            var art = Artists.Where(str => str.Hometown == "Mount Vernon").ToList();
            ...
            //=========================================================
            var art2 = Artists.OrderBy(a=>a.Age).ToList();
            System.Console.WriteLine(art2[0].ArtistName);
            //=========================================================
            //Display all artists with 'William' somewhere in their 
            //real name        
            //=========================================================
            var art3 = Artists.Where(q => q.RealName.Contains("%William%")).ToList();
